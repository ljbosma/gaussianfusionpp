...
def debug_lfa_frustum(obj, out, snap, ax, opt, phase):
    ...
    try:
        ...
        vx_comp = snap[idx_vx]
        # proceed with vx_comp-related debug logic...
    except ValueError:
        print("[debug_lfa_frustum] 'vx_comp' not in snap_channels, skipping vx_comp visualisation.")
        vx_comp = None
    # optionally skip related visuals or plot placeholder
    ...
    try:
        ...
        print("[debug_lfa_frustum] 'vz_comp' not in snap_channels, skipping vz_comp visualisation.")
        vz_comp = None
        # optionally skip related visuals or plot placeholder
    ...
    if phase == 'train':
        if 'velocity' in obj:
            ...
            # draw velocity arrow or whatever
        else:
            print("[debug_lfa_frustum] 'velocity' not in obj, skipping velocity visualization.")
